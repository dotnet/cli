...
cp $DIR/dotnet-dnx.sh $STAGE2_DIR/bin/dotnet-dnx
...
# Package Command test on the output
header "Testing stage2 Package Commands ..."
DOTNET_HOME=$STAGE2_DIR DOTNET_TOOLS=$STAGE2_DIR $DIR/test/package-command-test.sh
