...
namespace Microsoft.DotNet.Cli.Build
{
    public class TestTargets
    {
        ...
        public static BuildTargetResult RestoreTestAssetPackages(BuildTargetContext c)
        {
            ...
            dotnet.Restore("--verbosity", "verbose", "--infer-runtimes").WorkingDirectory(Path.Combine(c.BuildContext.BuildDirectory, "TestAssets", "TestPackages")).Execute().EnsureSuccessful();
        ...
        public static BuildTargetResult RestoreTestAssetProjects(BuildTargetContext c)
        {
            ...
            dotnet.Restore("--verbosity", "verbose", "--infer-runtimes", "--fallbacksource", Dirs.TestPackages)
