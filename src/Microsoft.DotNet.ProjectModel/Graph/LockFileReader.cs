...
//            if (framework != null)
//            {
//                library.Framework = NuGetFramework.Parse(framework);
//            }

//            library.Dependencies = ReadObject(jobject.ValueAsJsonObject("dependencies"), ReadPackageDependency);
//            library.FrameworkAssemblies = new HashSet<LockFile>(ReadObject(jobject.ValueAsJsonObject("frameworkAssemblies"), ReadFileItem), StringComparer.OrdinalIgnoreCase);
...
//            return new LockFileRuntimeTarget(path: property)
//            {
...
//                string.IsNullOrEmpty(property) ? null : property,
