...
namespace Microsoft.DotNet.ProjectModel
{
    public class WorkspaceContext
    {
        ...
        public static WorkspaceContext Create(ProjectReaderSettings settings, bool designTime) => new WorkspaceContext(Enumerable.Empty<string>(), settings, designTime);
        ...
        public IReadOnlyList<ProjectContext> GetProjectContexts(string projectPath) => (IReadOnlyList<ProjectContext>)GetProjectContextCollection(projectPath)?.ProjectContexts.AsReadOnly() ?? EmptyArray<ProjectContext>.Value;
        ...
        private bool RidsMatch(string rid, IEnumerable<string> compatibleRids)
        {
