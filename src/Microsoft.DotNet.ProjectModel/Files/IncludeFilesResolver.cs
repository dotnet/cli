...
namespace Microsoft.DotNet.ProjectModel.Files
{
    public class IncludeFilesResolver
    {
        ...
        public IEnumerable<IncludeEntry> GetIncludeFiles(string targetBasePath)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var targetPath = Path.Combine(targetBasePath, Path.GetFileName(file));
            ...
            if (_mappings != null)
            {
                ...
                foreach (var map in _mappings)
                {
                    ...
                    includeFiles.UnionWith(map.Value.GetIncludeFiles(targetPath));
