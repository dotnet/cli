    ...
    public class DependencyContextWriter
    {
        ...
        private JObject WriteTargetLibrary(Library library)
        {
            ...
            if (runtimeLibrary != null)
            {
                ...
                AddAssets(libraryObject, DependencyContextStrings.RuntimeAssembliesKey, runtimeLibrary.RuntimeAssemblyGroups.FirstOrDefault(r => string.IsNullOrEmpty(r.Runtime)));
                AddAssets(libraryObject, DependencyContextStrings.NativeLibrariesKey, runtimeLibrary.NativeLibraryGroups.FirstOrDefault(r => string.IsNullOrEmpty(r.Runtime)));
