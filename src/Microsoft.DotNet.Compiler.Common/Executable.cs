...
namespace Microsoft.Dotnet.Cli.Compiler.Common
{
    public class Executable
    {
        ...
        private void CopyAssemblies(IEnumerable<LibraryExport> libraryExports)
        {
            ...
            {
                libraryExport.RuntimeAssemblyGroups.GetGroup(string.Empty).CopyTo(_runtimeOutputPath);
                libraryExport.NativeLibraryGroups.GetGroup(string.Empty).CopyTo(_runtimeOutputPath);
            }
        }
        ...
        {
            return GenerateLines(export, export.RuntimeAssemblyGroups.GetGroup(string.Empty), "runtime")
                .Union(GenerateLines(export, export.NativeLibraryGroups.GetGroup(string.Empty), "native"));
        }
