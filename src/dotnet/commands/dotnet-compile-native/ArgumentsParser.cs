...
namespace Microsoft.DotNet.Tools.Compiler.Native
{
    internal static class ArgumentsParser
    {
        internal static ArgValues Parse(IEnumerable<string> args)
        {
            ...
            CommandOption enableInterop = app.Option("--enableinterop", "Mcg based interop support.", CommandOptionType.BoolValue);
            ...
            app.OnExecute(() =>
            {
                ...
                argValues.EnableInterop = enableInterop.BoolValue ?? false;
