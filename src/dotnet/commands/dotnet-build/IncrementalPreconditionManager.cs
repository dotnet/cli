...
namespace Microsoft.DotNet.Tools.Build
{
    ...
    class IncrementalPreconditionManager
    {
        ...
        public IncrementalPreconditions GatherIncrementalPreconditions(ProjectGraphNode projectNode)
        {
            var preconditions = new IncrementalPreconditions(_printPreconditions);
