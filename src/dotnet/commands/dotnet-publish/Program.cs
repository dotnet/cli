...
namespace Microsoft.DotNet.Tools.Publish
{
    public partial class PublishCommand
    {
        public static int Run(string[] args)
        {
            ...
            // Temporary until RID inference is removed
            var portable = app.Option("--portable", "Temporary mechanism to force portable publishing mode", CommandOptionType.NoValue);
            ...
            app.OnExecute(() =>
            {
                ...
                publish.PortableMode = portable.HasValue();
