...
namespace pal
{
    ...
    inline bool preload_native_libs() { return false; }
    void pal::process_native_paths(const std::unordered_set<pal::string_t>& native_dir_paths);
    ...
    inline bool preload_native_libs() { return true; }
