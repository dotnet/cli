...
//
//
bool deps_resolver_t::resolve_probe_paths(const pal::string_t& clr_dir, probe_paths_t* probe_paths, std::unordered_set<pal::string_t>* serviceable)
{
    resolve_tpa_list(clr_dir, &probe_paths->tpa, serviceable);
    resolve_probe_dirs(deps_entry_t::asset_types::native, clr_dir, &probe_paths->native, serviceable);
    resolve_probe_dirs(deps_entry_t::asset_types::resources, clr_dir, &probe_paths->resources, serviceable);
    return true;
}
