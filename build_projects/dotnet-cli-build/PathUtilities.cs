...
namespace Microsoft.DotNet.Cli.Build
{
    ...
    {
        public static string MakeRelative(string path1, string path2, char separator = default(char))
        {
        ...
        private static TaskItem ToTaskItem(string path)
        {
            var framework = new TaskItem();
            framework.ItemSpec = "RelativePath";

            framework.SetMetadata("Identity", path);
