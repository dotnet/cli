...
namespace Microsoft.DotNet.Cli.Build
{
    public class Monikers
    {
        ...
        public const string SharedFxBrandName = "Microsoft .NET Core 1.1.0 - Runtime";
        public const string SharedHostBrandName = "Microsoft .NET Core 1.1.0 - Host";
        public const string HostFxrBrandName = "Microsoft .NET Core 1.1.0 - Host FX Resolver";

        private const string CLISdkBrandName = "Microsoft .NET Core 1.1.0 - SDK 1.0.0 Preview 2.1-{COMMIT_COUNT_STRING}";
