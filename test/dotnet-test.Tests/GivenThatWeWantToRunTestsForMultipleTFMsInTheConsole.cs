...
namespace Microsoft.Dotnet.Tools.Test.Tests
{
    public class GivenThatWeWantToRunTestsForMultipleTFMsInTheConsole : TestBase
    {
        ...
        [Fact]
        public void It_skips_build_when_the_no_build_flag_is_passed_fornetcoreapp()
        {
        ...
        [Fact]
        public void It_skips_build_when_the_no_build_flag_is_passed_fordesktop()
        {
            var buildCommand = new BuildCommand(_projectFilePath);
            var result = buildCommand.Execute();
            result.Should().Pass();
            ...
            var testCommand = new DotnetTestCommand();
            result = testCommand.Execute($"{_projectFilePath} -f net451 -o {_defaultNet451OutputPath} --no-build");
            result.Should().Pass();
        }
