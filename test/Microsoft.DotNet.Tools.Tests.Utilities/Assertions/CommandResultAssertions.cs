...
namespace Microsoft.DotNet.Tools.Test.Utilities
{
    public class CommandResultAssertions
    {
		...
		{
		    _commandResult.StdOut.Should().Contain($"Project {skippedProject}");
		    _commandResult.StdOut.Should().Contain("was previously compiled. Skipping compilation.");
        ...
        {
            _commandResult.StdOut.Should().Contain($"Project {compiledProject}");
            _commandResult.StdOut.Should().Contain("will be compiled");
