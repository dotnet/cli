...
namespace Microsoft.DotNet.Configurer.UnitTests
{
    public class GivenANuGetCachePrimer
    {
        ...
        private Mock<ICommandFactory> SetupCommandFactoryMock()
        {
            ...
            commandFactoryMock
                .Setup(c => c.Create("new", new[] { "mvc", "-f", "1.0", "-au", "Individual", "--debug:ephemeral-hive" }, null, Constants.DefaultConfiguration))
                .Returns(_dotnetNewCommandMock.Object);
            commandFactoryMock
                .Setup(c => c.Create("new", new[] { "mvc", "-f", "1.1", "-au", "Individual", "--debug:ephemeral-hive" }, null, Constants.DefaultConfiguration))
                .Returns(_dotnetNewCommandMock.Object);
