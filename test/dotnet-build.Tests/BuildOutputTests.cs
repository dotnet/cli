...
//        [InlineData("net461", true, true)]
        ...
        public void UnresolvedReferenceCausesBuildToFailAndNotProduceOutput()
        {
            ...
            var buildResult = buildCmd.Execute();
            buildResult.Should().Fail();

            buildResult.StdOut.Should().Contain("The dependency ThisIsNotARealDependencyAndIfSomeoneGoesAndAddsAProjectWithThisNameIWillFindThemAndPunishThem could not be resolved.");
