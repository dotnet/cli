...
namespace Microsoft.DotNet.Tools.Test.Utilities
{
    public class TestCommand
    {
        ...
        public TestCommand(string executable)
        {
            _executable = executable;
        }

        public virtual CommandResult Execute(string args = "", bool captureOutput = false)
        {
            var commandPath = _executable;
        ...
        private CommandResult RunExecutableProcess(string executable, string args, StreamForwarder stdOut, StreamForwarder stdErr)
        {
