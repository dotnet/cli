...
namespace Microsoft.Extensions.DependencyModel.Tests
{
    public class DependencyContextBuilderTests
    {
        ...
        public void FillsRuntimeLibraryProperties()
        {
            ...
            lib.RuntimeAssemblyGroups.GetGroup(string.Empty).Should().OnlyContain(l => l.Path == "lib/Pack.Age.dll");
            lib.RuntimeAssemblyGroups.GetGroup("win8-x64").Should().OnlyContain(l => l.Path == "win8-x64/Pack.Age.dll");
            lib.NativeLibraryGroups.GetGroup("win8-x64").Should().OnlyContain(l => l.Path == "win8-x64/Pack.Age.native.dll");
            ...
            asm.RuntimeAssemblyGroups.GetGroup(string.Empty).Should().OnlyContain(l => l.Path == "System.Collections.dll");
        }
