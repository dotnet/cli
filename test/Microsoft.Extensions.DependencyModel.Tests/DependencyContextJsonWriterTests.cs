            ...
            var result = Save(Create(
                            ...
                            runtimeLibraries: new[]
                            {
                                new RuntimeLibrary(
                                        ...
                                        "HASH",
                                        new [] {
                                            new RuntimeAssetGroup(RuntimeAsset.Create("Banana.dll")),
                                            new RuntimeAssetGroup("win7-x64",RuntimeAsset.Create("Banana.Win7-x64.dll"))
                                        },
                                        new [] {
                                            new RuntimeAssetGroup(RuntimeAsset.Create("runtimes\\linux\\native\\native.so")),
                                            new RuntimeAssetGroup("win7-x64", RuntimeAsset.Create("native\\Banana.Win7-x64.so"))
                                        },
            ...
            var result = Save(Create(
                            ...
                            runtimeLibraries: new[]
                            {
                                new RuntimeLibrary(
                                        ...
                                        new [] {
                                            new RuntimeAssetGroup(RuntimeAsset.Create("native.dll")),
                                            new RuntimeAssetGroup("win7-x64", RuntimeAsset.Create("Banana.Win7-x64.so"))
                                        },
            ...
            var result = Save(Create(
                            ...
                            runtimeLibraries: new[]
                            {
                                new RuntimeLibrary(
                                        ...
                                        new [] {
                                            new RuntimeAssetGroup(RuntimeAsset.Create("runtimes\\osx\\native\\native.dylib"))
                                        },
                                        new ResourceAssembly[] {},
                                        new [] {
                                            new Dependency("Fruits.Abstract.dll","2.0.0")
                            ...
                            runtimeLibraries: new[]
                            {
                                new RuntimeLibrary(
                                        ...
                                        new [] {
                                            ...
                                            new RuntimeAssetGroup("win7-x86", RuntimeAsset.Create("lib\\x86Support.dll"))
                                        },
                                        new [] {
                                            new RuntimeAssetGroup("linux-x64"),
                                            new RuntimeAssetGroup("osx", RuntimeAsset.Create("native\\OSXSupport.dylib"))
                                        },
                                        new ResourceAssembly[] { },
                                        new Dependency[] { },
                                        true
